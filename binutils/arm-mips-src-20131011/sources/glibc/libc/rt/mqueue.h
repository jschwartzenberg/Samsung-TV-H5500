...
extern ssize_t mq_timedreceive_relative (mqd_t __mqdes, char *__restrict __msg_ptr,
                                size_t __msg_len,
                                unsigned int *__restrict __msg_prio,
                                const struct timespec *__restrict __rel_timeout)
  __nonnull ((2, 5));
...
extern int mq_timedsend_relative (mqd_t __mqdes, const char *__msg_ptr,
                         size_t __msg_len, unsigned int __msg_prio,
                         const struct timespec *__rel_timeout)
  __nonnull ((2, 5));
