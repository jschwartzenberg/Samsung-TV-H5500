...
extern int getenv_r (const char *__name, char *__buf, int __buflen) __THROW __nonnull ((1)) __wur;
__END_NAMESPACE_STD
...
extern int setenv (const char *__name, const char *__value, int __replace)
     __THROW __nonnull ((2));
extern int setenv_r (const char *__name, const char *__value, int __replace)
     __THROW __nonnull ((2));

/* Remove the variable NAME from the environment.  */
extern int unsetenv (const char *__name) __THROW __nonnull ((1));
extern int unsetenv_r (const char *__name) __THROW __nonnull ((1));
#endif
