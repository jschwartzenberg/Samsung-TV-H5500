		...
		ALLOCATE_STACK_PARMS)
{
 ...
 /* VDLinux, glibc 2MB default stack size patch, 2010-02-01
    * If thread's default stack-size is 8M(8,388,608bytes),
    * stack-size will change with 2M(2097152ytes)
    * for efficient memory policy embedded system like DigitalTV.
    */
