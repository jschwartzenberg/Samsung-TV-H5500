...
extern int __pthread_cond_timedwait_relative (pthread_cond_t *cond,
				     pthread_mutex_t *mutex,
				     const struct timespec *reltime);
extern int __getenv_r (const char *name, char *buf, int buflen);
extern int __setenv_r (const char *name, const char *value, int replace);
extern int __putenv_r (const char *string);
extern int __unsetenv_r (const char *name);
